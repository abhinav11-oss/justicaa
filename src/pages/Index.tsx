...
const Index = () => {
  const [activeTab, setActiveTab] = useState(() => {
    return sessionStorage.getItem('lastTab') || "chat";
  });
  ...
  const handleTabChange = (value: string) => {
    setActiveTab(value);
    sessionStorage.setItem('lastTab', value);
  };
  ...
  // Show dashboard if user is logged in and no service is selected
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
              <TabsList className="grid w-full grid-cols-5 bg-slate-100">
                ...
                <TabsTrigger value="generator" className="flex items-center space-x-2">
                  ...
                  <span className="hidden sm:inline">Doc Generator</span>
                  <span className="sm:hidden">Generate</span>
                </TabsTrigger>
                <TabsTrigger value="guides" className="flex items-center space-x-2">
                  <BookOpen className="h-4 w-4" />
                  <span className="hidden sm:inline">Legal Guides</span>
          ...
          <CardContent>
            <Tabs value={activeTab} className="w-full">
              ...
              <TabsContent value="lawyers">
                <LawyerFinder category={selectedCategory} />
              </TabsContent>
